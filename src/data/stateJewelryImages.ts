...
export const stateJewelryImages: Record<string, StateJewelryImage> = {
  ...
  "Jammu and Kashmir": vam("2006BB4858", "O90622", "Coral and turquoise jewellery, Kashmir/Ladakh"),
  ...
  Orissa: vam("2019MD2345", "O1316453", "Cuttack Tarakasi silver filigree, Odisha"),
  ...
  Uttaranchal: vam("2019MH1381", "O1505178", "Pahari gold ornament, Uttarakhand"),
  "West Bengal": vam("2019MJ1909", "O1504280", "Bengali gold jewellery"),
  Delhi: vam("2006AV2232", "O109582", "Navaratna pendant, Delhi"),
  // States/UTs without a verifiable museum piece intentionally omitted → placeholder:
  // Meghalaya, Mizoram, Tripura, Jharkhand, Sikkim, Chandigarh,
