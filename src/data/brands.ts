...
export const brands: Brand[] = [
  ...
  { name: "Amrapali", location: "Jaipur, Rajasthan, India", category: "Based in India", types: ["Traditional", "Bridal"], description: "Heritage jewelry house founded in 1978, reviving tribal, fine and uncut gemstone jewelry rooted in Rajasthani traditions.", website: "amrapali.com" },
  { name: "Kavya Potluri", location: "Hyderabad, India", category: "Based in India", types: ["Contemporary", "Fine Jewelry"], description: "Forbes 30 Under 30 Asia luxury demi-fine label, handcrafted in-house, rooted in bold storytelling and intricate craftsmanship.", website: "kavyapotluri.com" },
